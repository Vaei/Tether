...
public:
	 ...
	 * @param TetherShape     Pointer to the FTetherShape object whose state is being recorded.
	 ...
	 */
	virtual void RecordPhysicsState(FTetherIO* RecordedData, float TimeStamp, FTetherShape* TetherShape, const FTetherIO* LinearInputData, const FTetherIO* AngularInputData) const;
	 ...
	 * @param TetherShape     Pointer to the FTetherShape object whose state is being restored.
	 ...
	 */
	virtual bool ReplayPhysicsState(const FTetherIO* RecordedData, float TimeStamp, FTetherShape* TetherShape, FTetherIO* OutLinearInput, FTetherIO* OutAngularInput) const;
};
