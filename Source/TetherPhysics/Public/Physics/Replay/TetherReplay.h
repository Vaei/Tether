...
public:
	 ...
	 */
	virtual void RecordPhysicsState(const FTetherShape* Shape, FTetherIO* RecordedData, double TimeStamp,
	 ...
	 */
	virtual bool ReplayPhysicsState(const FTetherShape* Shape, const FTetherIO* RecordedData, double TimeStamp,
		FTetherIO* OutLinearInput, FTetherIO* OutAngularInput, ETetherReplayMode ReplayMode = ETetherReplayMode::Completion) const;
};
